...
Future<List<Usuario>> listarUsuario() async {
  ...
  final response = await client.get(Uri.parse('http://192.168.1.113:3000/paraki/usuario/listar'));
...
void cadastrarUsuario(Usuario usuario) async{
   ...
   await client.post(Uri.parse('http://192.168.1.113:3000/paraki/usuario/cadastrar'), headers: {"content-type":"application/json"}, body: jsonUsuario); 
